...
#define CONFIG_DEFAULT_STARTSTOPRECORDCC 32
#define CONFIG_DEFAULT_STARTSTOPPLAYBACKCC 33
#define CONFIG_DEFAULT_NEXT_TRACKCC 34
#define CONFIG_DEFAULT_PREVIOUS_TRACKCC 35
